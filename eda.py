...
def run():
    ...
    st.write('''Perubahan iklim global dan masalah lingkungan semakin menjadi perhatian utama di seluruh dunia. Salah satu kontributor utama 
                ...
                pada tahun 2023 menurut **_International Energy Agency_** (_IEA_) sektor transportasi menyumbang sekitar **27%** dari total emisi CO2 ([IEA](https://www.iea.org/reports/co2-emissions-in-2023)).
                Kanada merupakan salah satu negara yang paling banyak menyumbang Emisi karbon dioksida yang berasal dari transportasi dengan total **206 g/km** pada tahun 2019 ([National Observer](https://www.nationalobserver.com/2019/09/04/analysis/canadian-cars-are-worlds-dirtiest-ev-age-essential)).
